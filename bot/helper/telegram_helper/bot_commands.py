...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = [f'm{CMD_SUFFIX}', 'mall']
        self.QbMirrorCommand = [f'qm{CMD_SUFFIX}', 'qmall']
        self.YtdlCommand = [f'yt{CMD_SUFFIX}', f'ytdl{CMD_SUFFIX}']
        self.LeechCommand = [f'l{CMD_SUFFIX}', 'lall']
        self.QbLeechCommand = [f'ql{CMD_SUFFIX}', 'qlall']
        ...
        self.AuthorizeCommand = [f'auth{CMD_SUFFIX}', 'auth']
        self.UnAuthorizeCommand = [f'unauth{CMD_SUFFIX}', 'unauth']
        ...
        self.PingCommand = ['ping', f'p{CMD_SUFFIX}']
        ...
        self.BotSetCommand = [f'bs{CMD_SUFFIX}', 'bsall']
        self.UserSetCommand = [f'us{CMD_SUFFIX}', 'usall']
