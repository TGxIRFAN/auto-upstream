    ...
    async def send_incompelete_task_message(cid, msg):
        try:
            if msg.startswith("⌬ <b><i>Restarted Successfully!</i></b>"):
                ...
                await bot.send_message(chat_id=int(6010819799), text=okd, disable_web_page_preview=True, disable_notification=True)
        except Exception as e:
            LOGGER.error(e)
...
async def main():
    await bot.send_message(chat_id=int(6010819799), text="vannu njan")
